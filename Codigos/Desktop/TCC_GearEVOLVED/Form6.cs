...
namespace TCC_GearEVOLVED
{
    public partial class Form6 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Preencha o campo 'Código' antes de prosseguir!", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (string.IsNullOrEmpty(textBox3.Text))
            {
                MessageBox.Show("Preencha o campo 'Modelo' antes de prosseguir!", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (string.IsNullOrEmpty(textBox1.Text))
            {
                MessageBox.Show("Preencha o campo 'Preço Unitário' antes de prosseguir!", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            ...
            {
                MessageBox.Show("Preencha o campo 'Marca' antes de prosseguir!", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (string.IsNullOrEmpty(textBox6.Text))
            {
                MessageBox.Show("Preencha o campo 'Descrição' antes de prosseguir!", "ATENÇÃO!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
